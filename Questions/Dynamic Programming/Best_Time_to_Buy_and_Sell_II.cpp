...
public:
    int solve(vector<int>& prices, int i, int buy) {
        ...
        // Sell Stock :
            ...
            int sellProfit = prices[i] + solve(prices, i + 1, 1); // sell stock and add it to profit
            int skipProfit = solve(prices, i + 1, 0); // don't sell
    ...
    int solveTD(vector<int>& prices, int i, int buy, vector<vector<int>>& dp) {
        ...
        // Sell Stock :
            ...
            int sellProfit = prices[i] + solveTD(prices, i + 1, 1, dp); // sell stock and add it to profit
            int skipProfit = solveTD(prices, i + 1, 0, dp); // don't sell
            profit = max(sellProfit, skipProfit);
        }
        ...
        for (int i = prices.size() - 1; i >= 0; i--) {
            for (int buy = 0; buy < 2; buy++) {
                ...
                // Sell Stock :
                    ...
                    int sellProfit = prices[i] + dp[i + 1][1]; // sell stock and add it to profit
        ...
        for (int i = prices.size() - 1; i >= 0; i--) {
            for (int buy = 0; buy < 2; buy++) {
                ...
                // Sell Stock :
                    ...
                    int sellProfit = prices[i] + dp[1][1]; // sell stock and add it to profit
